...
- Restricted account subscription, upgrade, billing-event, and export-request data to tenant administrators and sanitized account/admin/records route 5xx responses.
...
- Inline account, admin, and records role-scoping/error-sanitization checks via `node -`
