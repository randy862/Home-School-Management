...
VALUES
  ...
  (
    ...
    TRUE,
    30,
    '["10 included billable students","$0.99 per billable student above 10","Attendance, grades, reports, and planning","Historical data preserved across school years"]'::jsonb,
    '{"includedBillableStudents":10,"perStudentOverageCents":99,"allowsOverage":true,"dormantBasePricePercentage":25}'::jsonb,
    NOW(),
    NOW()
  )
