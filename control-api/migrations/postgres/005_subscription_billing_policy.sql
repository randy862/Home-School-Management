...
VALUES
  ...
  (
    ...
    TRUE,
    30,
    '["11 students included","$0.99 per billable student above 11","Add students as needed","Everything in Growth","Full grades, attendance, and reports","Great for organized group instruction","Historical records preserved"]'::jsonb,
