...
VALUES
  (
    ...
    TRUE,
    10,
    '["1-3 billable students","Attendance, grades, reports, and planning","Hosted tenant with automated provisioning","Historical data preserved across school years"]'::jsonb,
  ...
  (
    ...
    TRUE,
    20,
    '["4-10 billable students","Attendance, grades, reports, and planning","Hosted tenant with automated provisioning","Historical data preserved across school years"]'::jsonb,
  ...
  (
    ...
    'large_monthly',
    'Valedictorian',
    'Hosted access for larger schools with a monthly base plus per-student overage after eleven billable students, framed as the top scholastic tier.',
    'month',
    1599,
    'usd',
    TRUE,
    TRUE,
    30,
    '["11 included billable students","$0.99 per billable student above 11","Attendance, grades, reports, and planning","Historical data preserved across school years"]'::jsonb,
