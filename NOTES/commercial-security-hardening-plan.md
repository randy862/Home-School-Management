...
- Tenant isolation still needs route-by-route IDOR testing and cross-tenant abuse tests; runtime-context fail-closed behavior, legacy state fail-closed behavior, and account/instructor/admin/records/curriculum/calendar role scoping have begun.
