...
- Tenant isolation still needs route-by-route IDOR testing and cross-tenant abuse tests; runtime-context fail-closed behavior and account/instructor/records role scoping have begun.
