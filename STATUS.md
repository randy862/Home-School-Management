...
- AWS pickup must include password reset, dashboard gauges, filter changes, Grade Search layout, and Course minutes/day UI.
...
3. Smoke AWS login, password reset, Course minutes/day editing, Attendance Search, School Day filtering, Grade Search filtering, dashboard gauges, and health endpoints.
